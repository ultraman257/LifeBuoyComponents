...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    Every other app organisation app was either paid for, didn't have all the features or wasn't customisable enough I created LifeBuoy. Designed with customisation and modularity at it's core LifeBuoy is as simple or complex as you need.
  </div>
