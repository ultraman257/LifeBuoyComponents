    ...
    const superMenu = (
        <>
            <a href={'#'} className={'superMenu-item'}>
                <h4>Admin Reset</h4>
                <p>
                    An alternative way to reset an account password. Refer to console for more
                    information.
                </p>
            </a>
        </>
        ...
        <div className={'lifebuoy-page--login'}>
            ...
            <div className={'loginForm'}>
                ...
                <TextInput
                    ...
                    helpText={'What do you want us to call you?'}
                />
                <TextInput
                    isError={isError}
                    setValue={handleFieldChange}
                ...
                <TextInput
                    ...
                    value={formData['password']}
                    overrideType={'password'}
                    helpText={"Enter your password again to make sure it's correct."}
                />
