...
export const Button = ({ onClick, content = 'Button', hasConfetti = false }) => {
    ...
    const animateConfetti = () => {
        ...
        let preComputed = [
            [
                [-64.4100022849874, -69.89602291605287],
                [13.18073599427067, 74.28329563289188],
                [-3.9639732330144275, 74.91184996279097],
                [-74.52272440735837, 70.12643286242677],
                [66.9457458737, -74.99951052951722]
            ],
            [
                [-9.52912464360802, -48.859800695698766],
                [74.9800613621542, -39.55122237388619],
                [63.82181974963763, -71.62819984129892],
                [69.90562298596686, 28.92736211363145],
                [-55.50224923675785, -28.359269714021448]
            ],
            [
                [-64.81244697877534, -48.91430176419997],
                [64.00079003205067, -6.733628827005125],
                [6.20462377018166, -29.455296296728797],
                [63.65512493860299, 74.09660470509067],
                [-69.35603770871856, 64.86866195628349]
            ],
            [
                [-74.8198019317224, 34.40754272258879],
                [-51.459335746396704, -51.13957080277644],
                [-29.24664532778292, 47.26983588308573],
                [-19.171319080889255, 74.13754850319484],
                [-37.8757688896789, -53.93123741851048]
            ],
            [
                [-4.7224168000296975, 47.60600881559445],
                [-55.3937990429614, -52.42389594953508],
                [-41.775551662565086, 33.549481033807545],
                [22.94457691358632, -19.563291919737072],
                [37.48145733876837, 36.06231360083062]
            ]
        ];
